...
public class moocOOP {
    ...
    public static void main(String args[]) {
       ...
       // Return a value from a method
        ...
        System.out.println("Enter positive integers. When you are done enter -1 to stop.");
        System.out.println("Your input will be calculated below.");
        ...
        PaymentCard card = new PaymentCard(50.00);
